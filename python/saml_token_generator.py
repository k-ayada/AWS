#!/opt/rh/python27/root/bin/python
...
idpentryurl = 'https://adfs.abc.com/adfs/ls/IdpInitiatedSignOn.aspx?loginToRp=urn:amazon:webservices'
...
if len(awsroles) > 1:
    ...
    for awsrole in awsroles:
        print '[', i, ']: ', awsrole.split(',')[0], "-----" , awsrole
        i += 1
    print "Selection: ",
...
token = conn.assume_role_with_saml(role_arn, principal_arn, assertion, None, 14400 )
